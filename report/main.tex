...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west, text=white, opacity=0.6] at ([xshift=2cm, yshift=-13.5cm]current page.north west) {
        ...
        \large\textbf{Student:} Zain-ul-Abdeen \\[6pt]
...
\input{chapters/ch4_ml_pipeline}
\input{chapters/ch5_rl_federated}
\input{chapters/ch6_visualization}
\input{chapters/ch7_web_dashboard}
\input{chapters/ch8_injection_engine}
\input{chapters/ch9_results}
